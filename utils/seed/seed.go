...
func SeedData(user *models.User) (err error) {
	...
	tagsMap := map[string]*models.Tag{
		"Wellness": {Name: "Wellness", Color: models.Turquoise, BoardID: &board.ID},
		"School":   {Name: "School", Color: models.Green, BoardID: &board.ID},
		"Fun":      {Name: "Fun", Color: models.Yellow, BoardID: &board.ID},
	}
